...
def filter(data : np.ndarray, stim_freq : int = 10, length : int = 300000, duration : int = 10, threshold : float = 0.65, max_count : int = 10, bin : bool = True) -> tuple[np.ndarray, list]:
